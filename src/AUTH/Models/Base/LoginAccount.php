...
abstract class LoginAccount implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\AUTH\\Models\\Map\\LoginAccountTableMap';
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildLoginAccountPassword> Collection to store aggregation of ChildLoginAccountPassword objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildLoginSession> Collection to store aggregation of ChildLoginSession objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildLoginAccountPassword>
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildLoginSession>
     */
     ...
     * @return void
     */
    public function resetPartialLoginAccountPasswords($v = true): void
    {
     ...
     * @return void
     */
    public function initLoginAccountPasswords(bool $overrideExisting = true): void
    {
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildLoginAccountPassword> List of ChildLoginAccountPassword objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countLoginAccountPasswords(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collLoginAccountPasswordsPartial && !$this->isNew();
        if (null === $this->collLoginAccountPasswords || null !== $criteria || $partial) {
     ...
     */
    protected function doAddLoginAccountPassword(ChildLoginAccountPassword $loginAccountPassword): void
    {
     ...
     * @return void
     */
    public function resetPartialLoginSessions($v = true): void
    {
     ...
     * @return void
     */
    public function initLoginSessions(bool $overrideExisting = true): void
    {
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildLoginSession> List of ChildLoginSession objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countLoginSessions(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collLoginSessionsPartial && !$this->isNew();
        if (null === $this->collLoginSessions || null !== $criteria || $partial) {
     ...
     */
    protected function doAddLoginSession(ChildLoginSession $loginSession): void
    {
