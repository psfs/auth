 ...
 *
 * @method     ChildLoginPath[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildLoginPath objects based on current ModelCriteria
 * @method     ChildLoginPath[]|ObjectCollection findByIdPath(int $ID_PATH) Return ChildLoginPath objects filtered by the ID_PATH column
 * @method     ChildLoginPath[]|ObjectCollection findByIdSocial(int $ID_PROVIDER) Return ChildLoginPath objects filtered by the ID_PROVIDER column
 * @method     ChildLoginPath[]|ObjectCollection findByType(int $TYPE) Return ChildLoginPath objects filtered by the TYPE column
 * @method     ChildLoginPath[]|ObjectCollection findByPath(string $PATH) Return ChildLoginPath objects filtered by the PATH column
...
abstract class LoginPathQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildLoginPathQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(LoginPathTableMap::COL_ID_PATH, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(LoginPathTableMap::COL_ID_PATH, $keys, Criteria::IN);
    }
     ...
     * @return $this|ChildLoginPathQuery The current query, for fluid interface
     */
    public function filterByIdPath($idPath = null, $comparison = null)
    {
        if (is_array($idPath)) {
            $useMinMax = false;
            if (isset($idPath['min'])) {
        ...
        return $this->addUsingAlias(LoginPathTableMap::COL_ID_PATH, $idPath, $comparison);
    }
    ...
    public function filterByIdSocial($idSocial = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(LoginPathTableMap::COL_ID_PROVIDER, $idSocial, $comparison);
    }
    ...
    public function filterByType($type = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(LoginPathTableMap::COL_TYPE, $type, $comparison);
    }
    ...
    public function filterByPath($path = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(LoginPathTableMap::COL_PATH, $path, $comparison);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildLoginPathQuery The current query, for fluid interface
     */
    public function filterByProviderPath($loginProvider, $comparison = null)
    {
     ...
     * @return $this|ChildLoginPathQuery The current query, for fluid interface
     */
    public function joinProviderPath($relationAlias = null, $joinType = 'INNER JOIN')
    {
