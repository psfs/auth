...
class LoginAccountPasswordTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'AUTH.Models.Map.LoginAccountPasswordTableMap';
     ...
     */
    const TABLE_NAME = 'AUTH_ACCOUNT_PASSWORDS';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\AUTH\\Models\\LoginAccountPassword';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'AUTH.Models.LoginAccountPassword';
     ...
     */
    const COL_ID_PASSWORD = 'AUTH_ACCOUNT_PASSWORDS.ID_PASSWORD';

    /**
     * the column name for the ID_ACCOUNT field
     */
    const COL_ID_ACCOUNT = 'AUTH_ACCOUNT_PASSWORDS.ID_ACCOUNT';

    /**
     * the column name for the VALUE field
     */
    const COL_VALUE = 'AUTH_ACCOUNT_PASSWORDS.VALUE';

    /**
     * the column name for the EXPIRATION_DATE field
     */
    const COL_EXPIRATION_DATE = 'AUTH_ACCOUNT_PASSWORDS.EXPIRATION_DATE';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'AUTH_ACCOUNT_PASSWORDS.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'AUTH_ACCOUNT_PASSWORDS.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdPassword', 'IdAccount', 'Value', 'ExpirationDate', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idPassword', 'idAccount', 'value', 'expirationDate', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(LoginAccountPasswordTableMap::COL_ID_PASSWORD, LoginAccountPasswordTableMap::COL_ID_ACCOUNT, LoginAccountPasswordTableMap::COL_VALUE, LoginAccountPasswordTableMap::COL_EXPIRATION_DATE, LoginAccountPasswordTableMap::COL_CREATED_AT, LoginAccountPasswordTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('ID_PASSWORD', 'ID_ACCOUNT', 'VALUE', 'EXPIRATION_DATE', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdPassword' => 0, 'IdAccount' => 1, 'Value' => 2, 'ExpirationDate' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idPassword' => 0, 'idAccount' => 1, 'value' => 2, 'expirationDate' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(LoginAccountPasswordTableMap::COL_ID_PASSWORD => 0, LoginAccountPasswordTableMap::COL_ID_ACCOUNT => 1, LoginAccountPasswordTableMap::COL_VALUE => 2, LoginAccountPasswordTableMap::COL_EXPIRATION_DATE => 3, LoginAccountPasswordTableMap::COL_CREATED_AT => 4, LoginAccountPasswordTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('ID_PASSWORD' => 0, 'ID_ACCOUNT' => 1, 'VALUE' => 2, 'EXPIRATION_DATE' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
  ...
  array (
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(LoginAccountPasswordTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(LoginAccountPasswordTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new LoginAccountPasswordTableMap());
        }
    }
...
} // LoginAccountPasswordTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
LoginAccountPasswordTableMap::buildTableMap();
