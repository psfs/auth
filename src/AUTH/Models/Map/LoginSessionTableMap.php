...
class LoginSessionTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'AUTH.Models.Map.LoginSessionTableMap';
     ...
     */
    public const TABLE_NAME = 'AUTH_SESSIONS';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'LoginSession';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\AUTH\\Models\\LoginSession';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'AUTH.Models.LoginSession';
     ...
     */
    public const COL_ID_ACCOUNT = 'AUTH_SESSIONS.ID_ACCOUNT';

    /**
     * the column name for the DEVICE field
     */
    public const COL_DEVICE = 'AUTH_SESSIONS.DEVICE';

    /**
     * the column name for the IP field
     */
    public const COL_IP = 'AUTH_SESSIONS.IP';

    /**
     * the column name for the TOKEN field
     */
    public const COL_TOKEN = 'AUTH_SESSIONS.TOKEN';

    /**
     * the column name for the ACTIVE field
     */
    public const COL_ACTIVE = 'AUTH_SESSIONS.ACTIVE';

    /**
     * the column name for the id field
     */
    public const COL_ID = 'AUTH_SESSIONS.id';

    /**
     * the column name for the created_at field
     */
    public const COL_CREATED_AT = 'AUTH_SESSIONS.created_at';

    /**
     * the column name for the updated_at field
     */
    public const COL_UPDATED_AT = 'AUTH_SESSIONS.updated_at';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdAccount', 'Device', 'IP', 'Token', 'Active', 'Id', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idAccount', 'device', 'iP', 'token', 'active', 'id', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [LoginSessionTableMap::COL_ID_ACCOUNT, LoginSessionTableMap::COL_DEVICE, LoginSessionTableMap::COL_IP, LoginSessionTableMap::COL_TOKEN, LoginSessionTableMap::COL_ACTIVE, LoginSessionTableMap::COL_ID, LoginSessionTableMap::COL_CREATED_AT, LoginSessionTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['ID_ACCOUNT', 'DEVICE', 'IP', 'TOKEN', 'ACTIVE', 'id', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdAccount' => 0, 'Device' => 1, 'IP' => 2, 'Token' => 3, 'Active' => 4, 'Id' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ],
        self::TYPE_CAMELNAME     => ['idAccount' => 0, 'device' => 1, 'iP' => 2, 'token' => 3, 'active' => 4, 'id' => 5, 'createdAt' => 6, 'updatedAt' => 7, ],
        self::TYPE_COLNAME       => [LoginSessionTableMap::COL_ID_ACCOUNT => 0, LoginSessionTableMap::COL_DEVICE => 1, LoginSessionTableMap::COL_IP => 2, LoginSessionTableMap::COL_TOKEN => 3, LoginSessionTableMap::COL_ACTIVE => 4, LoginSessionTableMap::COL_ID => 5, LoginSessionTableMap::COL_CREATED_AT => 6, LoginSessionTableMap::COL_UPDATED_AT => 7, ],
        self::TYPE_FIELDNAME     => ['ID_ACCOUNT' => 0, 'DEVICE' => 1, 'IP' => 2, 'TOKEN' => 3, 'ACTIVE' => 4, 'id' => 5, 'created_at' => 6, 'updated_at' => 7, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, 7, ]
    ];
