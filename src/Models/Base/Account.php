...
abstract class Account implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\PSFS\\Auth\\Models\\Map\\AccountTableMap';
    ...
    /**
     * Initializes internal state of PSFS\Auth\Models\Base\Account object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\PSFS\Auth\Models\Account The current object (for fluent API support)
     */
    ...
    public function setIdUser($v)
    {
        ...
        if ($this->id_user !== $v) {
            $this->id_user = $v;
            $this->modifiedColumns[AccountTableMap::COL_ID_USER] = true;
        }
    ...
    public function setIdExternal($v)
    {
        ...
        if ($this->id_external !== $v) {
            $this->id_external = $v;
            $this->modifiedColumns[AccountTableMap::COL_ID_EXTERNAL] = true;
        }
    ...
    public function setAccessToken($v)
    {
        ...
        if ($this->access_token !== $v) {
            $this->access_token = $v;
            $this->modifiedColumns[AccountTableMap::COL_ACCESS_TOKEN] = true;
        }
    ...
    public function setRefreshToken($v)
    {
        ...
        if ($this->refresh_token !== $v) {
            ...
            $this->modifiedColumns[AccountTableMap::COL_REFRESH_TOKEN] = true;
        }
    ...
    public function setExpires($v)
    {
        ...
        if ($this->expires !== $v) {
            $this->expires = $v;
            $this->modifiedColumns[AccountTableMap::COL_EXPIRES] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AccountTableMap::translateFieldName('IdUser', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AccountTableMap::translateFieldName('IdExternal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_external = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AccountTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AccountTableMap::translateFieldName('AccessToken', TableMap::TYPE_PHPNAME, $indexType)];
            $this->access_token = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AccountTableMap::translateFieldName('RefreshToken', TableMap::TYPE_PHPNAME, $indexType)];
            $this->refresh_token = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AccountTableMap::translateFieldName('Expires', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PSFS\\Auth\\Models\\Account'), 0, $e);
        }
    }
        ...
        $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                if ($this->archiveOnDelete) {
                    // do nothing yet. The object will be archived later when calling ChildAccountQuery::delete().
                } else {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AccountTableMap::COL_ID_USER)) {
            $modifiedColumns[':p' . $index++]  = 'ID_USER';
        }
        if ($this->isColumnModified(AccountTableMap::COL_ID_EXTERNAL)) {
            $modifiedColumns[':p' . $index++]  = 'ID_EXTERNAL';
        }
        if ($this->isColumnModified(AccountTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'TYPE';
        }
        if ($this->isColumnModified(AccountTableMap::COL_ACCESS_TOKEN)) {
            $modifiedColumns[':p' . $index++]  = 'ACCESS_TOKEN';
        }
        if ($this->isColumnModified(AccountTableMap::COL_REFRESH_TOKEN)) {
            $modifiedColumns[':p' . $index++]  = 'REFRESH_TOKEN';
        }
        if ($this->isColumnModified(AccountTableMap::COL_EXPIRES)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PSFS\Auth\Models\Account
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PSFS\Auth\Models\Account The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AccountTableMap::COL_ID_USER)) {
            $criteria->add(AccountTableMap::COL_ID_USER, $this->id_user);
        }
        if ($this->isColumnModified(AccountTableMap::COL_ID_EXTERNAL)) {
            $criteria->add(AccountTableMap::COL_ID_EXTERNAL, $this->id_external);
        }
        if ($this->isColumnModified(AccountTableMap::COL_TYPE)) {
            $criteria->add(AccountTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(AccountTableMap::COL_ACCESS_TOKEN)) {
            $criteria->add(AccountTableMap::COL_ACCESS_TOKEN, $this->access_token);
        }
        if ($this->isColumnModified(AccountTableMap::COL_REFRESH_TOKEN)) {
            $criteria->add(AccountTableMap::COL_REFRESH_TOKEN, $this->refresh_token);
        }
        if ($this->isColumnModified(AccountTableMap::COL_EXPIRES)) {
            $criteria->add(AccountTableMap::COL_EXPIRES, $this->expires);
        }
        if ($this->isColumnModified(AccountTableMap::COL_CREATED_AT)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PSFS\Auth\Models\Account (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PSFS\Auth\Models\Account Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return     ChildAccountsArchive An archive object, or null if the current object was never archived
     */
    public function getArchive(ConnectionInterface $con = null)
    {
        ...
        $archive = ChildAccountsArchiveQuery::create()
            ->filterByPrimaryKey($this->getPrimaryKey())
            ->findOne($con);
     ...
     *
     * @return     ChildAccountsArchive The archive object based on this object
     */
    public function archive(ConnectionInterface $con = null)
    {
        ...
        if (!$archive) {
            $archive = new ChildAccountsArchive();
     ...
     *
     * @param      ChildAccountsArchive $archive An archived object based on the same class
    ...
    public function populateFromArchive($archive, $populateAutoIncrementPrimaryKeys = false) {
        if ($populateAutoIncrementPrimaryKeys) {
            $this->setIdAccount($archive->getIdAccount());
        }
        $this->setIdUser($archive->getIdUser());
        $this->setIdExternal($archive->getIdExternal());
        $this->setType($archive->getType());
        $this->setAccessToken($archive->getAccessToken());
        $this->setRefreshToken($archive->getRefreshToken());
        $this->setExpires($archive->getExpires());
