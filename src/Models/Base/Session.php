...
abstract class Session implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\PSFS\\Auth\\Models\\Map\\SessionTableMap';
    ...
    /**
     * Initializes internal state of PSFS\Auth\Models\Base\Session object.
     */
     ...
     * @return $this|\PSFS\Auth\Models\Session The current object (for fluent API support)
     */
    ...
    public function setIdUser($v)
    {
        ...
        if ($this->id_user !== $v) {
            $this->id_user = $v;
            $this->modifiedColumns[SessionTableMap::COL_ID_USER] = true;
        }
    ...
    public function setToken($v)
    {
        ...
        if ($this->token !== $v) {
            $this->token = $v;
            $this->modifiedColumns[SessionTableMap::COL_TOKEN] = true;
        }
    ...
    public function setRefreshToken($v)
    {
        ...
        if ($this->refresh_token !== $v) {
            ...
            $this->modifiedColumns[SessionTableMap::COL_REFRESH_TOKEN] = true;
        }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SessionTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SessionTableMap::translateFieldName('IdUser', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SessionTableMap::translateFieldName('RefreshToken', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PSFS\\Auth\\Models\\Session'), 0, $e);
        }
    }
        ...
        $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                if ($this->archiveOnDelete) {
                    // do nothing yet. The object will be archived later when calling ChildSessionQuery::delete().
                } else {
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SessionTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(\Propel\Runtime\Util\PropelDateTime::createHighPrecision());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SessionTableMap::COL_ID_USER)) {
        ...
        if ($this->isColumnModified(SessionTableMap::COL_REFRESH_TOKEN)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PSFS\Auth\Models\Session
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PSFS\Auth\Models\Session The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SessionTableMap::COL_ID_USER)) {
            $criteria->add(SessionTableMap::COL_ID_USER, $this->id_user);
        }
        if ($this->isColumnModified(SessionTableMap::COL_IP)) {
        ...
        if ($this->isColumnModified(SessionTableMap::COL_REFRESH_TOKEN)) {
            $criteria->add(SessionTableMap::COL_REFRESH_TOKEN, $this->refresh_token);
        }
        if ($this->isColumnModified(SessionTableMap::COL_CREATED_AT)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PSFS\Auth\Models\Session (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PSFS\Auth\Models\Session Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return     ChildSessionsArchive An archive object, or null if the current object was never archived
     */
    public function getArchive(ConnectionInterface $con = null)
    {
        ...
        $archive = ChildSessionsArchiveQuery::create()
            ->filterByPrimaryKey($this->getPrimaryKey())
            ->findOne($con);
     ...
     *
     * @return     ChildSessionsArchive The archive object based on this object
     */
    public function archive(ConnectionInterface $con = null)
    {
        ...
        if (!$archive) {
            $archive = new ChildSessionsArchive();
     ...
     *
     * @param      ChildSessionsArchive $archive An archived object based on the same class
      * @param      Boolean $populateAutoIncrementPrimaryKeys
     *               If true, autoincrement columns are copied from the archive object.
     *               If false, autoincrement columns are left intact.
      *
     * @return     ChildSession The current object (for fluent API support)
     */
    public function populateFromArchive($archive, $populateAutoIncrementPrimaryKeys = false) {
        if ($populateAutoIncrementPrimaryKeys) {
            $this->setIdSession($archive->getIdSession());
        }
        $this->setIdUser($archive->getIdUser());
        $this->setIp($archive->getIp());
