...
use PSFS\Auth\Models\Session;
use PSFS\Auth\Models\SessionQuery;
...
class SessionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PSFS.Auth.Models.Map.SessionTableMap';
     ...
     */
    const OM_CLASS = '\\PSFS\\Auth\\Models\\Session';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PSFS.Auth.Models.Session';
     ...
     */
    const COL_ID_SESSION = 'Auth_SESSIONS.ID_SESSION';

    /**
     * the column name for the ID_USER field
     */
    const COL_ID_USER = 'Auth_SESSIONS.ID_USER';
     ...
     */
    const COL_REFRESH_TOKEN = 'Auth_SESSIONS.REFRESH_TOKEN';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSession', 'IdUser', 'Ip', 'Token', 'RefreshToken', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idSession', 'idUser', 'ip', 'token', 'refreshToken', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SessionTableMap::COL_ID_SESSION, SessionTableMap::COL_ID_USER, SessionTableMap::COL_IP, SessionTableMap::COL_TOKEN, SessionTableMap::COL_REFRESH_TOKEN, SessionTableMap::COL_CREATED_AT, SessionTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('ID_SESSION', 'ID_USER', 'IP', 'TOKEN', 'REFRESH_TOKEN', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdSession' => 0, 'IdUser' => 1, 'Ip' => 2, 'Token' => 3, 'RefreshToken' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idSession' => 0, 'idUser' => 1, 'ip' => 2, 'token' => 3, 'refreshToken' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(SessionTableMap::COL_ID_SESSION => 0, SessionTableMap::COL_ID_USER => 1, SessionTableMap::COL_IP => 2, SessionTableMap::COL_TOKEN => 3, SessionTableMap::COL_REFRESH_TOKEN => 4, SessionTableMap::COL_CREATED_AT => 5, SessionTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('ID_SESSION' => 0, 'ID_USER' => 1, 'IP' => 2, 'TOKEN' => 3, 'REFRESH_TOKEN' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PSFS\\Auth\\Models\\Session');
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(SessionTableMap::COL_ID_SESSION);
            $criteria->addSelectColumn(SessionTableMap::COL_ID_USER);
            $criteria->addSelectColumn(SessionTableMap::COL_IP);
            $criteria->addSelectColumn(SessionTableMap::COL_TOKEN);
            $criteria->addSelectColumn(SessionTableMap::COL_REFRESH_TOKEN);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PSFS\Auth\Models\Session) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(SessionTableMap::DATABASE_NAME);
            $criteria->add(SessionTableMap::COL_ID_SESSION, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(SessionTableMap::COL_ID_SESSION) && $criteria->keyContainsValue(SessionTableMap::COL_ID_SESSION) ) {
